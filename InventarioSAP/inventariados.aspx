<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="inventariados.aspx.vb" Inherits="InventarioSAP.inventariados" %>
					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container-xxl d-flex align-items-stretch justify-content-between">
							...
							<div class="d-flex align-items-center">
								<!--begin::Title-->
								<h3 class="text-dark fw-bolder my-1 fs-2">Productos Inventariados</h3>
								<!--end::Title-->
							</div>
							<!--end::Left-->
							<!--begin::Right-->
						...
						<div class="content fs-6 d-flex flex-column-fluid" id="kt_content">
							...
							<!--begin::Row-->
								<div class="d-flex bg-light-primary card-rounded flex-grow-1">
												...
												<div class="py-10 ps-7">
													...
													<asp:UpdatePanel ID="UpdatePanel4" runat="server">
														...
														<span class="fw-bolder fs-1 text-gray-800">
																	<asp:Label ID="lblcanregistros_inv_d" runat="server" Text=""></asp:Label>
								...
								<div class="modal-body">
											...
											<div class="row mb-8">
												<label class="col-lg-3 col-form-label">Código de Producto:</label>
											...
											<div class="col-lg-6">
													<div class="spinner spinner-sm spinner-primary spinner-right">
														...
														<%--<asp:TextBox ID="txtdescripcion2" runat="server" class="form-control" aria-label="With textarea" ></asp:TextBox>--%>
											...
											<div class="row mb-8">
												<label class="col-lg-3 col-form-label">Descripción del producto:</label>
											...
											<div class="row mb-8">
												...
												<table>
													<tr>
														<td class="col-lg-3"><label class="col-form-label">Seleccione Almacén (Zona):</label></td>
														<td class="col-lg-6">
															<div>
														...
														<td>
															<div >
																<div class="spinner spinner-sm spinner-primary spinner-right">
																	<asp:LinkButton ID="btnBuscarProducto2" runat="server" class="btn btn-primary btn-sm fw-bolder fs-6 ps-4 mt-6">Buscar Producto</asp:LinkButton>																												
															    </div>	
															</div>
														</td>
													</tr>
											...
											<div class="row mb-8">
												<label class="col-lg-3 col-form-label">Registrado por:</label>
													<div class="col-lg-6">
													<asp:UpdatePanel ID="UpdatePanel3" runat="server">
														<ContentTemplate>
															<asp:DropDownList ID="cboregistradopor" runat="server" class="form-select form-select-lg form-select-solid" AutoPostBack="True"></asp:DropDownList>
														</ContentTemplate>
													</asp:UpdatePanel>
										...
										<div class="pb-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="basic-table">Listado de Productos inventariados</h1>

										<div class="my-5" style="overflow: auto">
												...
												<%--lista de productos--%>
													...
													<asp:GridView ID="grvinventariados" runat="server" class="table product-overview" AutoGenerateColumns="False" AllowSorting="True">
															  <Columns>
																   ...
																   <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="left" ItemStyle-VerticalAlign="Middle" HeaderStyle-BackColor="" HeaderStyle-ForeColor="Black" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="60">
															   <ItemTemplate>
																			...
																			<table>
																				<tr>
																					...
																					<td>
																						...
																						<asp:Image ID="imageButton" runat="server" ImageUrl="~/images/editar.png" Width="20" Height="20"/>
																						</asp:LinkButton>
<%--																						<asp:LinkButton ID="btnmodificar" runat="server"  class="btn btn-sm btn-icon btn-active-light-primary me-1" CommandName="modificar" CommandArgument='<%# Bind("id_det_invent") %>' data-bs-toggle="tooltip" title="Modificar registro">
														...
														<asp:TemplateField HeaderText="Cod. Producto" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-BackColor="" HeaderStyle-ForeColor="Black" >
															...
															<asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Justify" ItemStyle-VerticalAlign="Middle" HeaderStyle-BackColor="" HeaderStyle-ForeColor="Black" >
															   <ItemTemplate>
...
<%--																		  <asp:LinkButton ID="btnEliminar" runat="server"  class="btn btn-sm btn-icon btn-active-light-primary me-1" CommandName="eliminar" CommandArgument='<%# Bind("id_det_invent") %>' data-bs-toggle="tooltip" title="Eliminar registro">
																...
																<%--<i class="bi bi-trash fs-3"></i>--%>
																	<asp:Image ID="imageButton2" runat="server" ImageUrl="~/images/eliminar.png" Width="20" Height="20"/>
							...
							<!--end::Row-->
								...
								<div class="modal fade" tabindex="-1" id="myModal_busqueda">
											<div class="modal-dialog">
													...
													<div class="modal-body">
														...
														<asp:TextBox ID="txtcantidad" runat="server" class="form-control form-control-solid" placeholder="Ingresar la cantidad encontrada" onkeypress="return NumCheck(event, this)"></asp:TextBox>
														</div>
														
													
														<div class="mb-6">
															<asp:LinkButton ID="btnRegistrar" runat="server" class="btn btn-bg-light">Registrar</asp:LinkButton>
														</div>
								...
								<div class="modal fade" tabindex="-1" id="myModal_Mensaje_elimina">
											<div class="modal-dialog">
													<div class="modal-content">
													<div class="modal-header">
														...
														<p>
															<asp:UpdatePanel ID="UpdatePanel5" runat="server">
																<ContentTemplate>
																	...
																	<asp:Label ID="lblmensaje_eliminacion" runat="server" Text=""></asp:Label>
																</ContentTemplate>
															</asp:UpdatePanel>
														</p>
													</div>
													...
													<div class="modal-footer">
														<asp:Button ID="btnaceptar_elimina" runat="server" Text="Eliminar" class="btn btn-light"/>
														<asp:Button ID="btncerrar_elimina" runat="server" Text="Cerrar" class="btn btn-light"/>
								...
								<div class="modal fade" tabindex="-1" id="myModal_Mensaje_modifica">
											<div class="modal-dialog">
													<div class="modal-content">
													<div class="modal-header">
														<h5 class="modal-title">Sistema de Inventario												<!--begin::Close-->
														...
														<p>
															<asp:UpdatePanel ID="UpdatePanel2" runat="server">
																<ContentTemplate>
																	...
																	<asp:Label ID="lblmensaje_modificacion" runat="server" Text=""></asp:Label>
																</ContentTemplate>
															</asp:UpdatePanel>
														</p>
													</div>
													...
													<div class="modal-footer">
														<asp:Button ID="btnmodificar" runat="server" Text="Modificar" class="btn btn-light"/>
								...
								<div class="modal fade" tabindex="-1" id="myModal_Mensaje">
											...
											<%--			<asp:LinkButton ID="btncerrar1" runat="server" class="btn btn-light" data-bs-dismiss="modal fade">LinkButton</asp:LinkButton>
														<button type="button" class="btn btn-primary">Save changes</button>--%>
														<asp:Button ID="btncerrar_mensaje" runat="server" Text="Cerrar" class="btn btn-light"/>
													</div>
												</div>
												</div>
								</div>
