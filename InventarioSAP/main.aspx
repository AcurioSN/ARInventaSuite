<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="main.aspx.vb" Inherits="InventarioSAP.main" %>
...
/* Hover sutil con identidad */
.admin-module:hover i {
    transform: scale(1.05);
}

.admin-module:hover {
    background: linear-gradient(180deg, #ffffff 0%, #f6eff5 100%);
}
...
<%--												<div class="menu-item">
													...
													<div class="menu-sub menu-fit menu-sub-accordion show pb-10">
														...
														<div class="menu-item">
															<a class="menu-link py-2" href="trabajar_inventario.aspx">
					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container-xxl d-flex align-items-stretch justify-content-between">
							...
							<div class="d-flex align-items-center">
								<!--begin::Title-->
								<h3 class="text-dark fw-bolder my-1 fs-2">Sistema de Inventario - SAP</h3>
								<!--end::Title-->
							</div>
							<!--end::Left-->
							<!--begin::Right-->
							...
							<!--begin::Row-->
								<div class="d-flex bg-light-dark card-rounded flex-grow-1">
												...
												<div class="py-10 ps-7">
													...
													<div class="mb-3">
														<!-- Título del mensaje -->
														<span class="fs-2 text-gray-800 font-weight-light">
															<asp:Label ID="lblmensaje_inv_activo" runat="server" Text=""></asp:Label>
														</span>

														<!-- Texto + Valor en la misma línea -->
														<span class="text-success d-block mt-2">
															Cantidad de registros inventariados:
															<strong>
																<asp:Label ID="lblcanregistros_inv" runat="server" Text=""></asp:Label>
															</strong>
														</span>
													</div>
													...
													<!--end::Text-->
													<%--<asp:LinkButton ID="btnAdministradorInventarios" runat="server" class="btn btn-primary btn-sm fw-bolder fs-6 ps-4 mt-6">Administrador Inventarios</asp:LinkButton>
													<asp:LinkButton ID="btnNuevoInventario" runat="server" class="btn btn-primary btn-sm fw-bolder fs-6 ps-4 mt-6">Nuevo inventario</asp:LinkButton>
													<asp:LinkButton ID="btnTrabajarInventario" runat="server" class="btn btn-primary btn-sm fw-bolder fs-6 ps-4 mt-6">Trabajar inventario</asp:LinkButton>
													<asp:LinkButton ID="btnCerrarInventario" runat="server" class="btn btn-danger btn-sm fw-bolder fs-6 ps-4 mt-6">Cerrar inventario</asp:LinkButton>
													<asp:LinkButton ID="btnExportarExcelSAP" runat="server" class="btn btn-primary btn-sm fw-bolder fs-6 ps-4 mt-6 ">Exportar TXT SAP</asp:LinkButton>--%>
...
<%--												<div class="position-relative bgi-no-repeat bgi-size-contain bgi-position-y-bottom bgi-position-x-end mt-6 flex-grow-1" style="background-image:url('theme/dist/assets/media/misc/illustration-1.png')"></div>--%>
    ...
    <div class="admin-panel">
        ...
        <div class="admin-modules">
            ...
            <asp:LinkButton ID="btnAdministradorInventarios" runat="server"
                CssClass="admin-module acurio-secondary">
                <i class="fas fa-boxes"></i>
                <span>Administrador<br />Inventarios</span>
            </asp:LinkButton>

            <asp:LinkButton ID="btnNuevoInventario" runat="server"
                CssClass="admin-module acurio-secondary">
                <i class="fas fa-plus-circle"></i>
                <span>Nuevo<br />Inventario</span>
            </asp:LinkButton>

            <asp:LinkButton ID="btnTrabajarInventario" runat="server"
                CssClass="admin-module acurio-secondary">
                <i class="fas fa-tools"></i>
                <span>Trabajar<br />Inventario</span>
            </asp:LinkButton>

            <asp:LinkButton ID="btnCerrarInventario" runat="server"
                CssClass="admin-module acurio-secondary">
                <i class="fas fa-lock"></i>
                <span>Cerrar<br />Inventario</span>
            </asp:LinkButton>

            <asp:LinkButton ID="btnExportarExcelSAP" runat="server"
                CssClass="admin-module acurio-secondary">
                <i class="fas fa-file-alt"></i>
                <span>Exportar TXT<br />SAP</span>
            </asp:LinkButton>

            <asp:LinkButton ID="btnExcelInventariados" runat="server"
                CssClass="admin-module acurio-secondary">
                <i class="fas fa-download"></i>
                <span>Descargar Conteo</span>
            </asp:LinkButton>
								...
								<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
									...
									<div class="container-xxl d-flex flex-column flex-md-row flex-stack">
										...
										<div class="text-dark order-2 order-md-1">
											...
											<a href="https://keenthemes.com" target="_blank" class="text-gray-800 text-hover-primary">Soluciones de Negocio</a>
										</div>
										<!--end::Copyright-->
										<!--begin::Menu-->
								...
								<div class="modal fade" tabindex="-1" id="myModal_busqueda">
											<div class="modal-dialog">
													...
													<div class="modal-body">
														...
														<div class="mb-6">
														<label for="exampleFormControlInput1" class="form-label">Inventario para la unidad:</label>
															<asp:Label ID="lbldescunidad_Nuevo_Inv" runat="server" Text="Tanta Chacarilla" class="form-control form-control-solid"></asp:Label>
														</div>
														<div class="mb-6">
														<label for="exampleFormControlInput1" class="form-label">Observación:</label>
															<asp:TextBox ID="txtobservacion_inv" runat="server" class="form-control form-control-solid" Rows="2"></asp:TextBox>
														</div>
														
														<div class="mb-6">
														<label for="exampleFormControlInput1" class="form-label">Cierre de Mes</label>
															<asp:CheckBox ID="chkcierre_mes" runat="server"/>
														</div>
														<br />
														<div class="mb-6">
								...
								<div class="modal fade" tabindex="-1" id="myModal_Mensaje">
									<div class="modal-dialog modal-md">
										<div class="modal-content text-center p-4 bg-white">
											...
											<!-- Título -->
											<h5 class="modal-title mb-2">AR Inventa</h5>
...
<%--		<div id="toastr-container" class="toastr-top-right">
			<div class="toastr toastr-success" aria-live="polite" style="">
				<button type="button" class="toastr-close-button" role="button">
				...
				<div class="toastr-title">
					<font style="vertical-align: inherit;">
						<font style="vertical-align: inherit;">Generando HTML!</font>
					</font>
				</div>
				<div class="toastr-message">
					<font style="vertical-align: inherit;">
						<font style="vertical-align: inherit;">El proceso ha comenzado y puede tardar un poco.</font>
					</font>
				</div>
			</div>
		</div>--%>
