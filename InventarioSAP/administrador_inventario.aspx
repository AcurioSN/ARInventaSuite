<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="administrador_inventario.aspx.vb" Inherits="InventarioSAP.busqueda_inventario" %>
					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container-xxl d-flex align-items-stretch justify-content-between">
							...
							<div class="d-flex align-items-center">
								<!--begin::Title-->
								<h3 class="text-dark fw-bolder my-1 fs-2">Administracion de Inventarios</h3>
								<!--end::Title-->
							</div>
							<!--end::Left-->
							<!--begin::Right-->
						...
						<div class="content fs-6 d-flex flex-column-fluid" id="kt_content">
							...
							<!--begin::Row-->
								...
								<div class="modal-body">
											<asp:Label ID="lblid_inventario" runat="server" Style="display:none;"></asp:Label>
											...
											<div class="row mb-8">
												...
												<tr>
														<td class="col-lg-3"><label class="col-form-label">Seleccione Año:</label></td>
														<td class="col-lg-6">
															<div>
																<asp:UpdatePanel ID="UpdatePanel1" runat="server">
																	<ContentTemplate>
																		<asp:DropDownList ID="cboanio" runat="server" class="form-select form-select-lg form-select-solid" AutoPostBack="True"></asp:DropDownList>
																	</ContentTemplate>
																</asp:UpdatePanel>													
															</div>
														</td>
													...
													<tr>
														<td class="col-lg-3"><label class="col-form-label">Seleccione Mes:</label></td>
														<td class="col-lg-6">
															<div>
																<asp:UpdatePanel ID="UpdatePanel11" runat="server">
																	<ContentTemplate>
																		<asp:DropDownList ID="cbomes" runat="server" class="form-select form-select-lg form-select-solid" AutoPostBack="True"></asp:DropDownList>
																	</ContentTemplate>
																</asp:UpdatePanel>													
															</div>
														</td>
									...
									<br />
										<div class="pb-10">
										<!--begin::Heading-->
										<%--<h1 class="anchor fw-bolder mb-4" id="basic-table">Listado de Productos inventariados</h1>--%>
										<h3 class="text-dark fw-bolder my-1 fs-2">Listado de Productos inventariados</h3>
												...
												<%--lista de productos--%>
													...
													<asp:GridView ID="grvinventariados" runat="server" class="table product-overview" AutoGenerateColumns="False" AllowSorting="True">
															  <Columns>
															   ...
															   <ItemTemplate>
																			...
																			<table>
																				<tr>
																					<td>
																						<asp:Label ID="lblid_det_invent" runat="server" Text='<%# Bind("id_inventario") %>' Visible="False"></asp:Label>
																						

																					</td>
																					<td>
																						<asp:LinkButton ID="btnExcelDetalle" runat="server"  class="btn btn-sm btn-icon btn-active-light-primary me-1" CommandName="excel" CommandArgument='<%# Bind("id_inventario") %>' data-bs-toggle="tooltip" title="Descargar Conteo">
																						<i class="bi bi-file-arrow-down fs-3"></i></asp:LinkButton>
																					</td>
																					<td>
																						

																						<asp:LinkButton ID="btnExportarExcelSAP" runat="server"  class="btn btn-sm btn-icon btn-active-light-primary me-1" CommandName="modificar" CommandArgument='<%# Bind("id_inventario") %>' data-bs-toggle="tooltip" title="Exportar TXT">
																						<i class="bi bi-download fs-3"></i></asp:LinkButton>
														   ...
														   <asp:TemplateField HeaderText="Descripción" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-BackColor="" HeaderStyle-ForeColor="Black" >
															   <ItemTemplate>
																		   <asp:Label ID="lblfecha_registro" runat="server" Text='<%# Bind("desc_inventario") %>'></asp:Label>
														...
														<asp:TemplateField HeaderText="Fecha" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-BackColor="" HeaderStyle-ForeColor="Black" >
															   <ItemTemplate>
																		   ...
																		   <asp:Label ID="lblcod_producto_inv" runat="server" Text='<%# Bind("fec_creac_inventario") %>' ToolTip=""></asp:Label>
															  ...
															  <asp:TemplateField HeaderText="Descripción" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-BackColor="" HeaderStyle-ForeColor="Black" >
															   <ItemTemplate>
																		   ...
																		   <asp:Label ID="lbldesc_producto_inv" runat="server" Text='<%# Bind("obs_inventario") %>' ToolTip=""></asp:Label>
							...
							<!--end::Row-->
								...
								<div class="modal fade" tabindex="-1" id="myModal_Mensaje_modifica">
											<div class="modal-dialog">
													...
													<div class="modal-footer">
														<asp:Button ID="btnExportarExcelSAP" runat="server" Text="Modificar" class="btn btn-light"/>
